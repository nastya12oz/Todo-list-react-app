...
class ToDoList extends React.Component {
  ...
  toggleComplete(id, completed) {
    ...
    fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}/mark_${newState}?api_key=308`, {
      method: "PUT",
      mode: "cors",
    }).then(checkStatus)
      .then(json)
  ...
  deleteTask(id) {
    ...
    fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}?api_key=308`, {
      method: "DELETE",
      mode: "cors",
    }).then(checkStatus)
      .then(json)
  ...
  fetchTasks() {
    fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=308")
    .then(checkStatus)
    .then(json)
    .then((response) => {
